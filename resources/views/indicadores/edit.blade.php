...
@endif
  ...
  <input type="text" class="form-control" id="nombreIndicador" name="nombreIndicador" value="{{$indicador->nombreIndicador ?? ''}}" placeholder="Ingrese Nombre Indicador">
</div>
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Codigo Indicador</label>
  <input type="text" class="form-control" id="codigoIndicador" name="codigoIndicador" value="{{$indicador->codigoIndicador ?? ''}}" placeholder="Ingrese Codigo Indicador">
</div>
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Unidad Medida Indicador</label>
  <input type="text" class="form-control" id="unidadMedidaIndicador" name="unidadMedidaIndicador" value="{{$indicador->unidadMedidaIndicador ?? ''}}" placeholder="Ingrese Unidad de medida Indicador">
</div>
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Valor Indicador</label>
  <input type="text" class="form-control" id="valorIndicador" name="valorIndicador" value="{{$indicador->valorIndicador ?? ''}}" placeholder="Ingrese Valor del Indicador">
</div>
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Fecha Indicador</label>
  <input type="date" class="form-control" id="fechaIndicador" name="fechaIndicador" value="{{$indicador->fechaIndicador ?? ''}}" placeholder="Ingrese Fecha del Indicador">
</div>
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">Tiempo del Indicador</label>
  <input type="text" class="form-control" id="tiempoIndicador" name="tiempoIndicador" value="{{$indicador->tiempoIndicador ?? ''}}" placeholder="Tiempo del Indicador">
</div>
